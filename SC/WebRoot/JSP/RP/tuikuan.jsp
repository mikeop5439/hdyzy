		...
		<div class="center" >
			<div class="col-main" >
								...
								<div class="am-cf am-padding" >
									<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">售后</strong> </div>
								</div>
								<hr/>

								<div style="margin: 0 auto;margin-top: 50px;">
									<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath }/personcar/applyinvoice.action" method="post">
					...
					<div class="m-progress">
						<div class="m-progress-list">
							<span class="step-1 step">
                                ...
                                <p class="stage-name">申请</p>
                            </span>
							<span class="step-2 step">
                                <em class="u-progress-stage-bg"></em>
                                <i class="u-stage-icon-inner">2<em class="bg"></em></i>
                                <p class="stage-name">同意申请</p>
                            </span>
						...
						<div class="u-progress-bar total-steps-2">
							<div class="u-progress-bar-inner"></div>
										...
										<div class="am-form-group" >
											...
											<div class="am-form-content" style="width: 430px;margin: 0 auto">
											    <input  type="hidden" name="order_id" value="${param.order_id}">
												<textarea name="apply_reason"class="" rows="4" id="user-intro" placeholder="输入退款说明："></textarea>
												<small>100字以内写出你的退款说明...</small>
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<center><input type="submit" class="am-btn am-btn-secondary" value="申请" /></center>		
