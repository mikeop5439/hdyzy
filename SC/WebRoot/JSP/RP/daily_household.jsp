		...
		<div class="container">
			<div class="col-md-4 products-left">
				<div class="categories">
					<h2>全部商品分类</h2>
					<ul class="cate">
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>老年理疗产品</a></li>
							
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>老年日常用品</a></li>
							
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>老年健身产品</a></li>
							
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>老年按摩产品</a></li>
							
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>家庭医疗机械</a></li>
							
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>中老年服饰</a></li>
						
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>孝心礼品类</a></li>
