...
<link rel="icon" type="image/png"
	href="${pageContext.request.contextPath}/JSP/HT/assets/i/favicon.png">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/JSP/HT/assets/css/amazeui.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/JSP/HT/assets/css/admin.css">

<script
	src="${pageContext.request.contextPath}/JSP/HT/assets/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/JSP/HT/assets/js/app.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/JSP/HT/assets/js/jquery.validate.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/JSP/HT/assets/js/additional-methods.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/JSP/HT/assets/js/jquery.validate.extend.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/JSP/HT/assets/js/addgoods.js"></script>
</head>
<body>
...
<body>
	...
	<div class="am-topbar-brand">
		<img src="${pageContext.request.contextPath}/JSP/HT/assets/i/logo.png">
	</div>
		...
		<div class=" admin-content">
			...
			<div class="am-popup am-popup-inner" id="my-update">
				...
				<div class="am-popup-bd">
					<form id="addbrand" class="am-form tjlanmu"
						action="${pageContext.request.contextPath}/goods/addbrand.action"
						...
						<div class="am-form-group">
							...
							<div class="you">
								<input type="text" id="brand_name" name="brand_name"
									class="am-input-sm" id="doc-ipt-email-1" placeholder="请输品牌" />
							</div>
						</div>
			...
			<div class="admin-biaogelist">
				...
				<div class="listbiaoti am-cf">
					<ul class="am-icon-user on">用户收货地址
					</ul>
				...
				<div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
					<ul>
						<form
							action="${pageContext.request.contextPath }/userlist/sogoreceiverByid.action"
							method="post">

							<li><input name="sogo" type="text"
								class="am-form-field am-input-sm am-input-xm"
								style="margin-top: -0.5px;height: 28px;margin-top: 3px;width:200px; "
								placeholder="输入用户ID/用户名查找" /></li>
					...
					<ul>
						<form
							action="${pageContext.request.contextPath }/userlist/sogoreceiver.action"
							method="post">
							<li><input name="sogo" type="text"
								class="am-form-field am-input-sm am-input-xm"
								style="margin-top: -0.5px;height: 28px;margin-top: 3px;width:200px; "
								placeholder="输入收货地址查询" /></li>
							<li><button type="submit"
									class="am-btn am-radius am-btn-xs am-btn-success"
									style="margin-top: 1px;">搜索</button></li>
						</form>
				...
				<form class="am-form am-g">
					<table width="100%"
						...
						<thead>
							<tr class="am-success">
								...
								<th class="table-name">收货人</th>
								<th class="table-name">省份</th>
								<th class="table-name">城市</th>
								<th class="table-name">区/县</th>
								<th class="table-name">街道</th>
								<th class="table-name">邮政编码</th>
								<th class="table-name">收货电话</th>
							</tr>
						</thead>
						<tbody id="tbody">
							<c:forEach items="${receivers }" var="u">
								<tr>
									<td align="center" valign="middle"
										rowspan="${u.getReceiver().size()+1 }">${u.getUser_id()}</td>
									<td valign="middle" rowspan="${u.getReceiver().size()+1 }">
										<a>${u.getUser_name()}</a>
									</td>

									<c:forEach items="${u.getReceiver()}" var="c">
										<tr>
											<td id="3">${c.getReceiver_name()}</td>
											<td id="4">${c.getReceiver_state()}</td>
											<td id="5">${c.getReceiver_city()}</td>
											<td id="6">${c.getReceiver_district()}</td>
											<td id="6">${c.getReceiver_address()}</td>
											<td id="6">${c.getReceiver_postcode()}</td>
											<td id="6">${c.getReceiver_phone()}</td>
										</tr>
									</c:forEach>
								</tr>
							</c:forEach>
					...
					<ul class="am-pagination am-fr">
						...
						<li><a id="a"
							href="${pageContext.request.contextPath}/userlist/queryreceiverlistpage.action?daslkdjkadsadgfdgjkjhesakls=<%=new Date() %>&daslkdjkadsadgfdgjkjhesakls=<%=new Date() %>&page=1&xia=1&shang=1">1</a></li>
						<li><a id="a"
							href="${pageContext.request.contextPath}/userlist/queryreceiverlistpage.action?daslkdjkadsadgfdgjkjhesakls=<%=new Date() %>&daslkdjkadsadgfdgjkjhesakls=<%=new Date() %>&page=2&xia=1&shang=1">2</a></li>
						<li><a id="a"
							href="${pageContext.request.contextPath}/userlist/queryreceiverlistpage.action?daslkdjkadsadgfdgjkjhesakls=<%=new Date() %>&daslkdjkadsadgfdgjkjhesakls=<%=new Date() %>&page=3&xia=1&shang=1">3</a></li>
						<li><a id="a"
						...
						<li>
							<form action="${pageContext.request.contextPath}/userlist/queryreceiverlistpage.action" method="post" onsubmit="return sogopages()">
								...
								<input type="text" name="page"
									class="am-form-field am-input-sm am-input-xm"
									style="height:20px; width: 53px" placeholder="输入页码搜索" /> <input
...
<![endif]-->
	...
	<!--[if (gte IE 9)|!(IE)]><!-->
	<script
		src="${pageContext.request.contextPath}/JSP/HT/assets/js/amazeui.min.js"></script>
	<!--<![endif]-->
