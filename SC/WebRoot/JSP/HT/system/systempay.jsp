...
<script type="text/javascript">
	$(document).ready(function(){
	  ...
	  function updatepayway(id){  
	   var payway_id = id;
	   var $params="payway_id="+payway_id;
       $.ajax({  
           type:"POST",  
           url:"${pageContext.request.contextPath }/updatePayWayPre.action",
           data: $params,
		   success:function(data){
			   $("#payway_id").val(data.payway_id);
			   $("#payway_name").val(data.payway_name); 
		  }	   
       });  
      };
          
         function deleteinfo(id){
		     var url="deletePayWay.action?payway_id="+id;
		     $("#deletepayway").attr("href",url); 	 	     
	  	 };     
        ...
        $.ajax({
           type:"POST",
           url:"${pageContext.request.contextPath }/payWayQuery.action",
           data:$params,         
	       success:function(data){
				setpage(data.pages,nowpage);	            
	     		$("#t2sysl tr").remove();
	     		$.each(data.list,function(index,content){			  
				  var td1=$("<td style='text-align: center;'></td>").append($("<input type='checkbox'/>").val(content.payway_id).attr("name","payway_id"));
				  var td2=$("<td style='text-align: center;'></td>").append(content.payway_name);
				  ...
				  .attr("data-am-modal","{target: '#my-popup'}").attr("title","修改").attr("onclick","javascript:updatepayway("+content.payway_id+")");
				  var a2=$("<a></a>").addClass("am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-trash-o")
				  .attr("data-am-modal","{target: '#my-confirm'}").attr("title","删除").attr("onclick","javascript:deleteinfo("+content.payway_id+")");
  ...
  <div class=" admin-content">
    ...
    <div class="am-popup am-popup-inner" id="my-popup">
      <div class="am-popup-hd">
        <h4 class="am-popup-title">编辑支付方式</h4>
      ...
      <div class="am-popup-bd">
        ...
        <form class="am-form tjlanmu" action="${pageContext.request.contextPath }/updatePayWay.action" method="POST" enctype="multipart/form-data">
          <div class="am-form-group am-cf">   
          	<div class="zuo"><input id="payway_id" type="hidden" name="payway_id" value="${paywayquery.payway_id }"></div>
          </div>
          
          <div class="am-form-group">
            <div class="zuo">支付方式：</div>
            <div class="you">
              <input id="payway_name" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入链接名称" name="payway_name" value="">
            </div>
          </div>
    ...
    <div class="am-popup am-popup-inner" id="my-addpopup">
      <div class="am-popup-hd">
        <h4 class="am-popup-title">新增支付方式</h4>
        <span data-am-modal-close
            class="am-close">&times;</span> 
      </div>
      ...
      <div class="am-popup-bd">
        ...
        <form class="am-form tjlanmu" action="${pageContext.request.contextPath }/addPayWay.action" method="POST" enctype="multipart/form-data">
          <%-- <div class="am-form-group am-cf">   
          ...
          <div class="am-form-group">
            <div class="zuo">支付方式：</div>
            <div class="you">
              <input id="addpayway_name" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入链接名称" name="payway_name" value="">
            </div>
          </div>
    ...
    <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;">
          当前位置： 支付方式 > <a href="${pageContext.request.contextPath }">首页</a>
        </dl>
