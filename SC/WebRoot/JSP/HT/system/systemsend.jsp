...
<script type="text/javascript">
	$(document).ready(function(){
	  ...
	  function updatepostway(id){  
	   var postway_id = id;
	   var $params="postway_id="+postway_id;
       $.ajax({  
           type:"POST",  
           url:"${pageContext.request.contextPath }/updatePostWayPre.action",
           data: $params,
		   success:function(data){
			   $("#postway_id").val(data.postway_id);
			   $("#postway_name").val(data.postway_name);
		  }	   
       });  
      };
          
         function deleteinfo(id){
		     var url="deletePostWay.action?postway_id="+id;
		     $("#deletepostway").attr("href",url); 	 	     
	  	 };     
        ...
        $.ajax({
           type:"POST",
           url:"${pageContext.request.contextPath }/postWayQuery.action",
           data:$params,         
	       success:function(data){
				setpage(data.pages,nowpage);	            
	     		$("#t2sysl tr").remove();
	     		$.each(data.list,function(index,content){			  
				  var td1=$("<td style='text-align: center;'></td>").append($("<input type='checkbox'/>").val(content.postway_id).attr("name","postway_id"));
				  var td2=$("<td style='text-align: center;'></td>").append(content.postway_name);
				  ...
				  .attr("data-am-modal","{target: '#my-popup'}").attr("title","修改").attr("onclick","javascript:updatepostway("+content.postway_id+")");
				  var a2=$("<a></a>").addClass("am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-trash-o")
				  .attr("data-am-modal","{target: '#my-confirm'}").attr("title","删除").attr("onclick","javascript:deleteinfo("+content.postway_id+")");
				  var td3=$("<td style='text-align: center;'></td>").append(a1).append(a2);
				  
				  $("#t2sysl").append($("<tr></tr>").append(td1).append(td2).append(td3));
	            });
	       }
       });
     }
  ...
  <div class=" admin-content">
    ...
    <div class="am-popup am-popup-inner" id="my-popup">
      <div class="am-popup-hd">
        <h4 class="am-popup-title">编辑配送方式</h4>
      ...
      <div class="am-popup-bd">
        ...
        <form class="am-form tjlanmu" action="${pageContext.request.contextPath }/updatePostWay.action" method="POST" enctype="multipart/form-data">
          <div class="am-form-group am-cf">   
          	<div class="zuo"><input id="postway_id" type="hidden" name="postway_id" value="${postwayquery.postway_id }"></div>
          </div>
          
          <div class="am-form-group">
            <div class="zuo">配送方式：</div>
            <div class="you">
              <input id="postway_name" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入链接名称" name="postway_name" value="">
            </div>
          </div>
    ...
    <div class="am-popup am-popup-inner" id="my-addpopup">
      <div class="am-popup-hd">
        <h4 class="am-popup-title">新增配送方式</h4>
        <span data-am-modal-close
            class="am-close">&times;</span> 
      </div>
      ...
      <div class="am-popup-bd">
        ...
        <form class="am-form tjlanmu" action="${pageContext.request.contextPath }/addPostWay.action" method="POST" enctype="multipart/form-data">
          <%-- <div class="am-form-group am-cf">   
          ...
          <div class="am-form-group">
            <div class="zuo">配送方式：</div>
            <div class="you">
              <input id="addpostway_name" type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入链接名称" name="postway_name" value="">
            </div>
          </div>
    ...
    <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;">
          当前位置： 配送方式> <a href="${pageContext.request.contextPath }">首页</a>
        </dl>
